...
#BOARD_MKBOOTIMG_ARGS := --ramdisk_offset 0x01000000 --tags_offset 0x00000100 --dt $(LOCAL_PATH)/LS-5015-kernel/dt.imgTARGET_PREBUILT_KERNEL := $(LOCAL_PATH)/LS-5015-kernel/kernel
